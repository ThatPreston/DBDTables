...
Note: After installing or updating Dead By Daylight, you must allow it to fully load at least once for certain files such as `catalog.json` to update.

![](https://i.gyazo.com/44bcfff95915eaaa5e858ba7a0c6efe6.png)
